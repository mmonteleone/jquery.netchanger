...
task :release => [:build] do
  root = pwd+'/dist'
  zip_archive = pwd+'/dist/jquery.netchanger.zip'
...
task :test => [:build] do  
  begin
    # mac
    sh("open spec/jquery.netchanger.specs.html")
  rescue
    # windows
    sh("start spec/jquery.netchanger.specs.html")
  end
end
